    ...
    <div class="container " id="containerDetail">
        ...
        <h1 class="text-center mb-4 mt-5" >Detail</h1>
    <div class="row p-5" >
        ...
        <div class="col-md-5 col-sm-8 ">
            <div class=" thumbnail-container ">
                <div >
                    <img id="mainImage" src="{{ asset($produit->image) }}" class="w-100  h-50 img-principal" alt="...">
                </div>
            ...
            <div class="col-md-5 col-sm-12  ">
                <div class="product-details">
                    ...
                    <form action="{{ route('ajouterPanier') }}" method="POST">
                        ...
                        <button class="btn  text-light rounded-3 btn-success w-25 ms-5" >
                            <a  href="{{route('connecterIDproduit',$produit->id)}}"> <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20" height="30" viewBox="0 0 48 48">
    ...
    <div >
        ...
        <div class="container mt-5" style="margin-bottom: 1000px">
