                   ...
                   <div class="row  ">
                    ...
                    <div class="col-lg-4 col-md-6 text-center">
                        <div class="single-product-item">
                            ...
                            <h3>{{ $produit->nom }}</h3>
                            <p class="product-price"><span>{{ $produit->prix }} DH</span> </p>
                            <p class="strike-text"><span>{{$produit->prixRemise}} DH</span> </p>
                            ...
                            <form action="{{ route('ajouterPanier') }}" method="POST" style="margin-top: 20px">
                               ...
                               <button type="button" class="btn btn-success wts-btn">
